...
do
    ...
    samtools faidx denovo_assemblies/$name/scaffolds.fasta $scaff:$start_pos-$end_pos -o seq_$name.fasta
    samtools faidx -i denovo_assemblies/$name/scaffolds.fasta $scaff:$end_pos-$start_pos -o seq_rev_$name.fasta 
